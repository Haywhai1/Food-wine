...
const AboutUs = () => {
  ...
  />
  <h3 className="font-bold relative text-center ml-32" style={{ fontFamily: "Righteous, sans-serif" }}>
    About Us
    <span className="absolute bottom-[-3px] left-1/2 transform -translate-x-1/2 w-80 h-1.5 bg-black"></span>
  </h3>
</div>
